...
with_node \
  ...
  --target "/Users/ginopaolobenitez/GitHub/Test-Bentobox-App/ios/Pods/Target Support Files/Pods-BentoboxApp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-file-system" "expo-keep-awake" "expo-linear-gradient"
